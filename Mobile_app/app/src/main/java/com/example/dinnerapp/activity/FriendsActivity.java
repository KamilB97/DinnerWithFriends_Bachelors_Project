...
public class FriendsActivity extends AppCompatActivity {
    ...
    String json_friendsList_url = "http://"+ ADDRESS.IP + ":8080/api/friends/" + 38;
...
//                        Intent a = new Intent(FriendsActivity.this, FriendsActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
//                        startActivity(a);
//                        finish();
                        break;
                    case R.id.navigation_conversation:
                        Intent b = new Intent(FriendsActivity.this, ConversationActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(b);
                        arrayList = null;
                        finish();
                        break;
                    ...
                    case R.id.navigation_matched:
                        Intent c = new Intent(FriendsActivity.this, MatchedActivity.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(c);
                        arrayList = null;
                        finish();
                        break;
...
//                                Log.d("DisplayParticularEntity", "image: " + profileBrief.getString("image"));
                                Friend friend = new Friend(
                                        jsonObject.getInt("friendshipId"),
...
//                                );
                        ...
                        adapter = new FriendsAdapter(FriendsActivity.this, arrayList);
